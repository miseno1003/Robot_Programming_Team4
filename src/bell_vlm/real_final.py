...
#
HOME_POSITION = {
    'x': -0.17649232536488632,
    'y': -0.16292119134584024,
    'yaw_deg': 0,
}
...
#
ROOM_GOALS = {
    102: {'x': -1.3046392523477761, 'y': 0.8606171027335516, 'yaw_deg': 70},
    103: {'x': -0.9674615068768022, 'y': -0.14024175755434123, 'yaw_deg': 180},
    105: {'x': -1.714626222226516, 'y': -0.9982261519024156, 'yaw_deg': -90},
    # 필요한 만큼 호수를 추가하세요.
}

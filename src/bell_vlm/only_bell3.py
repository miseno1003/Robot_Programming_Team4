...
# 벨을 못 찾았을 때 왼쪽(반시계)으로 탐색 회전하는 설정
# ROS 관례상 angular_z 양수 = 반시계 = 왼쪽
SEARCH_ANGULAR = 0.35    # 탐색 회전 각속도 (rad/s, 양수=왼쪽)
SEARCH_STEP_TIME = 0.4   # 한 번 탐색 회전 명령 지속 시간(초)
# 한 바퀴(약 360도) 다 돌아도 못 찾으면 경고.
# 누적 회전각이 이 값을 넘으면 한 바퀴 돈 것으로 간주.
